 ...
 *
 */
abstract class BaseChiTietPhieuNhap extends ThongTinSanPham {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'ChiTietPhieuNhap|ChiTietPhieuNhaps', $n);
	}
	...
	public function rules() {
		return array(
			...
			array('so_luong, gia_nhap', 'default', 'setOnEmpty' => true, 'value' => null),
