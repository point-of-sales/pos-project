...
class RAuthItemBehavior extends CBehavior
{
	...
	*/
    ...
    public function getNameValueText()
    {
        return (Rights::module()->displayDescription===true) ? $this->owner->name : $this->owner->description ;
    }

    public function getNameValueLink()
    {
        return CHtml::link($this->getNameValueText(), array(
            'authItem/update',
            'name'=>urlencode($this->owner->name),
        ));
    }
