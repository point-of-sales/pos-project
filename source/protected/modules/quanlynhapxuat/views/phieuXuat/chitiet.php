...
array(
			'name' => 'chiNhanhNhap',
			'type' => 'raw',
			'value' => $model->chiNhanhNhap !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->chiNhanhNhap)), array('chiNhanh/view', 'id' => GxActiveRecord::extractPkValue($model->chiNhanhNhap, true))) : null,
			),
	),
)); ?>
