...
?>
    ...
    AjaxTransferData.prototype.isOverInstock = function (url, ma_vach, chi_nhanh_id) {
        var strUrl = url + "laysoluongtonsanphamtang/ma_vach/" + ma_vach + "/chi_nhanh_id/" + chi_nhanh_id;
        var result = 'ok';
        var ret;
        $.ajax({
            url: strUrl,
...
$this->breadcrumbs = array(
    ...
    Yii::t('viLib', 'Export gift product'),
);
?>
...
<?php
$this->renderPartial('_formxuatsanphamtang', array(
    'model' => $model,
    'id' => isset($id) ? $id : null,
    'buttons' => 'create'));
?>