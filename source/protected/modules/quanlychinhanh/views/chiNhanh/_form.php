...
?>
	...
	<?php echo $form->errorSummary($model); ?>
		...
		<?php echo $form->dropDownList($model, 'truc_thuoc_id', GxHtml::listDataEx(ChiNhanh::model()->findAllAttributes(null, true))); ?>
		<?php echo $form->error($model,'truc_thuoc_id'); ?>
		</div><!-- row -->
		<div class="row cus-row">
		<?php echo $form->labelEx($model,'khu_vuc_id'); ?>
		<?php echo $form->dropDownList($model, 'khu_vuc_id', GxHtml::listDataEx(KhuVuc::model()->findAllAttributes(null, true))); ?>
		<?php echo $form->error($model,'khu_vuc_id'); ?>
		</div><!-- row -->
		<div class="row cus-row">
		<?php echo $form->labelEx($model,'loai_chi_nhanh_id'); ?>
		<?php echo $form->dropDownList($model, 'loai_chi_nhanh_id', GxHtml::listDataEx(LoaiChiNhanh::model()->findAllAttributes(null, true))); ?>
