...
?>
	...
	<?php echo $form->errorSummary($model); ?>
		...
		<?php echo $form->labelEx($model,'ma_loai_nhan_vien'); ?>
		<?php echo $form->textField($model, 'ma_loai_nhan_vien', array('maxlength' => 15)); ?>
		<?php echo $form->error($model,'ma_loai_nhan_vien'); ?>
		</div><!-- row -->
		<div class="row cus-row">
