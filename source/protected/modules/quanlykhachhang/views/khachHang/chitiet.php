...
array(
			'name' => 'loaiKhachHang',
			'type' => 'raw',
			'value' => $model->loaiKhachHang !== null ? GxHtml::link(GxHtml::encode(GxHtml::valueEx($model->loaiKhachHang)), array('loaiKhachHang/view', 'id' => GxActiveRecord::extractPkValue($model->loaiKhachHang, true))) : null,
			),
	),
)); ?>
