...
class LoaiKhachHangController extends CPOSController
{
    ...
    {
        if (Yii::app()->user->checkAccess('Quanlykhachhang.LoaiKhachHang.ChiTiet')) {
    ...
    {
        if (Yii::app()->user->checkAccess('Quanlykhachhang.LoaiKhachHang.Them')) {
    ...
    {
        if (Yii::app()->user->checkAccess('Quanlykhachhang.LoaiKhachHang.CapNhat')) {
            $model = $this->loadModel($id, 'LoaiKhachHang');
            if (isset($_POST['LoaiKhachHang'])) {
    ...
    {
        if (Yii::app()->user->checkAccess('Quanlykhachhang.LoaiKhachHang.XoaGrid')) {
    ...
    {
        if (Yii::app()->user->checkAccess('Quanlykhachhang.LoaiKhachHang.Xoa')) {
            if (Yii::app()->getRequest()->getIsPostRequest()) {
                $delModel = $this->loadModel($id, 'LoaiKhachHang');
                $message = '';
                $canDelete = true;
    ...
    {
        if (Yii::app()->user->checkAccess('Quanlykhachhang.LoaiKhachHang.DanhSach')) {
    ...
    {
        if (Yii::app()->user->checkAccess('Quanlykhachhang.LoaiKhachHang.Xuat')) {
            $model = new LoaiKhachHang('search');
            $model->unsetAttributes();
