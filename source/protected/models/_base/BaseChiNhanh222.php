 ...
 * property or method in class "ChiNhanh222".
 *
 ...
 *
 * @property ChiNhanh222 $trucThuoc
 * @property ChiNhanh222[] $chiNhanhs
 ...
 */
abstract class BaseChiNhanh222 extends ChiNhanh {
	...
	public static function label($n = 1) {
        if($n <= 1 ) {
            return Yii::t('viLib', 'ChiNhanh222');
        } else {
		    return Yii::t('viLib', 'ChiNhanh222s');
        }
	}
	...
	public function relations() {
		return array(
			'trucThuoc' => array(self::BELONGS_TO, 'ChiNhanh222', 'truc_thuoc_id'),
			'chiNhanhs' => array(self::HAS_MANY, 'ChiNhanh222', 'truc_thuoc_id'),
