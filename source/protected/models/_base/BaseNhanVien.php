...
abstract class BaseNhanVien extends CPOSActiveRecord {
	...
	public function attributeLabels() {
		return array(
			'id' => Yii::t('viLib', 'ID'),
			'ma_nhan_vien' => Yii::t('viLib', 'Ma Nhan Vien'),
			'ho_ten' => Yii::t('viLib', 'Ho Ten'),
			'email' => Yii::t('viLib', 'Email'),
			'dien_thoai' => Yii::t('viLib', 'Dien Thoai'),
			'dia_chi' => Yii::t('viLib', 'Dia Chi'),
			'gioi_tinh' => Yii::t('viLib', 'Gioi Tinh'),
			'ngay_sinh' => Yii::t('viLib', 'Ngay Sinh'),
			'trinh_do' => Yii::t('viLib', 'Trinh Do'),
			'luong_co_ban' => Yii::t('viLib', 'Luong Co Ban'),
			'chuyen_mon' => Yii::t('viLib', 'Chuyen Mon'),
			'trang_thai' => Yii::t('viLib', 'Trang Thai'),
			'mat_khau' => Yii::t('viLib', 'Mat Khau'),
			'ngay_vao_lam' => Yii::t('viLib', 'Ngay Vao Lam'),
			'lan_dang_nhap_cuoi' => Yii::t('viLib', 'Lan Dang Nhap Cuoi'),
