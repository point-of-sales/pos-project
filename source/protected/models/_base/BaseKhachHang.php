 ...
 */
abstract class BaseKhachHang extends CPOSActiveRecord {
	...
	public function attributeLabels() {
		return array(
			'id' => Yii::t('viLib', 'ID'),
			'ma_khach_hang' => Yii::t('viLib', 'Ma Khach Hang'),
			'ho_ten' => Yii::t('viLib', 'Ho Ten'),
			'ngay_sinh' => Yii::t('viLib', 'Ngay Sinh'),
			'dia_chi' => Yii::t('viLib', 'Dia Chi'),
			'thanh_pho' => Yii::t('viLib', 'Thanh Pho'),
			'dien_thoai' => Yii::t('viLib', 'Dien Thoai'),
			'email' => Yii::t('viLib', 'Email'),
			'mo_ta' => Yii::t('viLib', 'Mo Ta'),
			'diem_tich_luy' => Yii::t('viLib', 'Diem Tich Luy'),
